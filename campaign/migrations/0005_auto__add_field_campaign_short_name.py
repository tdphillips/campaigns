...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.short_name'
        db.add_column(u'campaign_campaign', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.short_name'
        db.delete_column(u'campaign_campaign', 'short_name')
