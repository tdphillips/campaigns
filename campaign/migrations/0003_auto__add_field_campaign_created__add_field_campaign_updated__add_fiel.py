...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'campaign_campaign', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Campaign.updated'
        db.add_column(u'campaign_campaign', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Prospectus.created'
        db.add_column(u'campaign_prospectus', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Prospectus.updated'
        db.add_column(u'campaign_prospectus', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 28, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'campaign_campaign', 'created')

        # Deleting field 'Campaign.updated'
        db.delete_column(u'campaign_campaign', 'updated')

        # Deleting field 'Prospectus.created'
        db.delete_column(u'campaign_prospectus', 'created')

        # Deleting field 'Prospectus.updated'
        db.delete_column(u'campaign_prospectus', 'updated')
